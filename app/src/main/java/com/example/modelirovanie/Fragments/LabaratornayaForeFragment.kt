...
import com.example.modelirovanie.starter4
import com.jjoe64.graphview.GraphView
import com.jjoe64.graphview.series.DataPoint
import com.jjoe64.graphview.series.LineGraphSeries

class LabaratornayaForeFragment:Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.fragment_labaratornaya_four,container,false)
    }
        ...
        bt.setOnClickListener{
            ...
            for(i in graphSeriesList.indices){
                ...
                when(i){
                    ...
                    6->lineGraphSeries.color=Color.rgb(100,250,30)
                    else-> Color.WHITE
                }
